...
public class StoredFeatureParserTests extends LuceneTestCase {
    ...
    public void assertTestFeature(StoredFeature feature) {
        ...
        assertEquals(writeAsNonFormattedString(new MatchQueryBuilder("match_field", "match_word")), feature.template());
    ...
    public void testParseFeatureAsString() throws IOException {
        ...
        String featureString = "{\n"
            ...
            + "\"template_language\": \"mustache\",\n"
            + "\"template\": \""
            + writeAsNonFormattedString(new MatchQueryBuilder("match_field", "match_word")).replace("\"", "\\\"")
            + "\"\n}\n";
    ...
    public void testToXContent() throws IOException {
        ...
        featureString = feature.toXContent(builder, ToXContent.EMPTY_PARAMS).toString();
    ...
    public void testParseErrorOnMissingName() throws IOException {
        String featureString = "{\n"
            ...
            + "}";
        assertThat(expectThrows(ParsingException.class, () -> parse(featureString)).getMessage(), equalTo("Field [name] is mandatory"));
    }
    ...
    public void testParseWithInconsistentExternalName() throws IOException {
        String featureString = "{\n"
            ...
            + "}";
        assertThat(
            expectThrows(ParsingException.class, () -> parse(featureString, "testFeature2")).getMessage(),
    ...
    public void testParseErrorOnBadTemplate() throws IOException {
        String featureString = "{\n"
            ...
            + "}";
        assertThat(
            expectThrows(IllegalArgumentException.class, () -> parse(featureString).optimize()).getMessage(),
    ...
    public void testParseErrorOnMissingTemplate() throws IOException {
        String featureString = "{\n"
            ...
            + "\"template_language\":\"mustache\"\n"
            + "}";
        assertThat(expectThrows(ParsingException.class, () -> parse(featureString)).getMessage(), equalTo("Field [template] is mandatory"));
    }
    ...
    public void testParseErrorOnUnknownField() throws IOException {
        String featureString = "{\n"
            ...
            + writeAsNonFormattedString(new MatchQueryBuilder("match_field", "match_word"))
            + "}";
        assertThat(expectThrows(ParsingException.class, () -> parse(featureString)).getMessage(), containsString("bogusField"));
    }
    ...
    public void testRamBytesUsed() throws IOException, InterruptedException {
        ...
        assertThat(feature.ramBytesUsed(), allOf(greaterThan((long) (approxSize * 0.66)), lessThan((long) (approxSize * 1.33))));
    }
    ...
    static StoredFeature parse(String featureString, String defaultName) throws IOException {
        return StoredFeature.parse(jsonXContent.createParser(EMPTY, LoggingDeprecationHandler.INSTANCE, featureString), defaultName);
    }

    private String writeAsNonFormattedString(AbstractQueryBuilder<?> builder) {
        return Strings.toString(MediaTypeRegistry.JSON, builder, false, false);
    }
}
